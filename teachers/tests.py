...
class UserTestCase(APITestCase):
    ...
    def setUp(self):
        self.user = self.client.post('/auth/users/', data={'username': ',mario', 'password': 'testuser'})
        response= self.client.post('/auth/jwt/create/', data={'username': ',mario', 'password': 'testuser'})
    ...
    def test_userprofile_profile(self):
        profile_data={'location': 'Dodoma','mobile': 'bongo', 'is_approved': 'true', }
